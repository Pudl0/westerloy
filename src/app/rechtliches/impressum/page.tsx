...
export default function LegalNotice() {
  return (
    <div className="p-3">
      ...
      <p className="px-32 py-12 text-3xl">Impressum</p>
      <div className="px-32 py-4">
        ...
        <p className="mb-2 mt-4 text-xl">2. Verweise und Links</p>Bei direkten oder indirekten Verweisen auf fremde
        Webseiten (&quotHyperlinks&quot), die außerhalb des Verantwortungsbereiches des Autors liegen, würde eine
        Haftungsverpflichtung ausschließlich in dem Fall in Kraft treten, in dem der Autor von den Inhalten Kenntnis hat
        und es ihm technisch möglich und zumutbar wäre, die Nutzung im Falle rechtswidriger Inhalte zu verhindern. Der
