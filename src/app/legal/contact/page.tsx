...
import { faPhone, faBriefcase, faEnvelope } from '@fortawesome/free-solid-svg-icons';
    ...
    return(
        <div className='px-4 py-2 w-80 shadow-lg border-2 rounded-lg'>
            ...
            <div className='flex items-center mt-4 text-gray-600 dark:text-gray-400'>
                ...
                <a href={`mailto:${mailAddress}`} className='ml-2 text-md tracking-wide font-semibold hover:underline'>{mailAddress}</a>
            </div>
        </div>
    );
}