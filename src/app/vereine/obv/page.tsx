  ...
  return (
    <div className="mt-10 w-full">
      ...
      <p className="pb-6">
            ...
            unserer Dorfbewohner*innen ein. Wir möchten ein lebendiges Miteinander von Jung & Alt unterstützen und das Lokale fördern.
        </p>
        <p className="pb-6">
            Mit zahlreichen tollen Veranstaltungen und Aktionen auch zusammen mit unserer Landjugend beleben wir unser Dorf
            rund um unseren Dorfmittelpunkt - unseren Mühlenhof - unser Dorfgemeinschaftshaus.
        </p>
        <p className="pb-6">
