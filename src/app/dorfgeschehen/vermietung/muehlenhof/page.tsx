    ...
    <div className="bg-gray-50 dark:bg-gray-900">
      ...
      <header className="bg-white dark:bg-gray-800 shadow-sm">
        <div className="container mx-auto py-8 px-4">
          <h1 className="text-3xl md:text-4xl font-bold text-center mb-2">Den Mühlenhof mieten</h1>
      ...
      <main className="container mx-auto py-8 px-4">
        <div className="grid gap-8 md:grid-cols-[2fr_1fr] lg:grid-cols-[3fr_1fr]">
          ...
          <div className="md:order-1">
            <CalendarWithICS icsLink={process.env.NEXT_PUBLIC_ICS_LINK_MUHELENHOF || ""} />
          </div>
          {/* Contact Information */}
